package com.pluralsight.apireview.controller;
...
//    @RequestMapping(path = "/", method = RequestMethod.GET)
    ...
    public List<Book> getAllBooks(@RequestParam(name = "title", required = false) String title,
                                  ...
                                  @RequestParam(name = "year", required = false) Integer publication_year){

        return bookService.getAllBooks(title, author, publication_year);
